...
/*Дана строка 'abcde'. Обращаясь к отдельным символам этой строки выведите на экран символ 'a'
let str = 'abcde';
...
/*let name = prompt("Введите возраст");
alert(name);*/
...
let c = prompt("Введите длину");
alert(2 * (Number(c) + Number(b)));*/
...
/*let ok = confirm("есть ли ему уже 18 лет?");
